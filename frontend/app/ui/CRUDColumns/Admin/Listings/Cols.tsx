...
export default function ListingsCol(payload: any, t: any) {
  const {
    data,
    deleteDoc,
    entityNameSingular,
  ...
  const columns: any[] = [
    {
      field: "order",
      headerName: t("listings.field.order"),
      width: 100,
    },
    {
      field: "name",
      flex: 1,
      headerName: t("listings.field.name"),
    },
    {
      field: "listing_category_name",
      flex: 1,
      headerName: t("listings.field.listing_category_name"),
    },
    {
      field: "active",
      headerName: "Active",
